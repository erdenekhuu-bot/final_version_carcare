...
class ForgotPasswordValidateMSG extends StatefulWidget {
  ...
  ForgotPasswordValidateMSG({Key? key, this.phoneNumber}) : super(key: key);

  @override
  State<ForgotPasswordValidateMSG> createState() => _ChangePhoneValidateMSGState();
}

class _ChangePhoneValidateMSGState extends State<ForgotPasswordValidateMSG> {
