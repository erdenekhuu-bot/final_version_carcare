...
class MySelfPhone extends StatefulWidget {
  final String? token;
  final String? phone;
  final String? username;
  final String? password;
  MySelfPhone({super.key, this.token, this.password, this.username, this.phone});

  @override
  State<MySelfPhone> createState() => _MySelfPhoneState();
}

class _MySelfPhoneState extends State<MySelfPhone> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView( 
        ...
        children: [
          const Center(child: Text('Хувийн мэдээлэл', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF404040))),
          ),
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Row(
                    children: [
                      Text('Нэр ', style: TextStyle(fontFamily: 'Inter-Light', fontSize: 15)),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: SizedBox(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: '${username}',
                        labelStyle: const TextStyle(fontFamily: 'Inter-Light', color: Color(0xFF404040), fontSize: 15, height: 0),
                        prefixIcon: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: SvgPicture.asset('images/person.svg', width: 20, height: 20),
                        ),
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      Text('Утасны дугаар', style: TextStyle(fontFamily: 'Inter-Light', fontSize: 15)),
                    ],
                  ),
                ),
                Container(
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      Text('Нууц үг', style: TextStyle(fontFamily: 'Inter', fontSize: 15)),
                    ],
                  ),
                ),
                Container(
                ...
                Container(
                    ...
                    child: ElevatedButton(
                        ...
                        if(_formKey.currentState!.validate()){
                          ...
                          if (_result != '') {
                            ...
                            Flushbar(
                              ...
                              titleText: Center(child: Icon(Icons.check_circle_outline_rounded, color: Colors.white, size: 28)),
                              messageText: Padding(
                                padding: EdgeInsets.only(bottom: 20.0),
                                child: Text("Хувийн мэдээлэл амжилттай хадгалагдлаа", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                              ),
                            ...
                            Flushbar(
                              ...
                              flushbarStyle: FlushbarStyle.GROUNDED,
                              flushbarPosition: FlushbarPosition.TOP,
                              titleText: const Center(child: Icon(Icons.error_outline, color: Colors.white, size: 28)),
                              messageText: const Padding(
                                padding: EdgeInsets.only(bottom: 20.0),
                                child: Text("Нэр, нууц үгээ оруулах шаардлагатай", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                              ),
                      ...
                      child: const Text('Хадгалах', style: TextStyle(fontFamily: 'Inter-Light', fontSize: 17, color: Colors.white)),
                    )),
                Container(
